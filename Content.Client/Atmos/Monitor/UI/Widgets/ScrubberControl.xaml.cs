...
public sealed partial class ScrubberControl : BoxContainer
{
    ...
    public ScrubberControl(GasVentScrubberData data, string address)
    {
        ...
        {
            _pumpDirection.AddItem(Loc.GetString("air-alarm-ui-scrubber-pump-direction", ("dir", value)), (int) value); // Ru-Localization
        }
        ...
        foreach (var value in Enum.GetValues<Gas>())
        {
            ...
            {
                Name = value.ToString(),
                Text = Loc.GetString($"atmos-gas-{value}"), // Ru-Localization
                ToggleMode = true,
