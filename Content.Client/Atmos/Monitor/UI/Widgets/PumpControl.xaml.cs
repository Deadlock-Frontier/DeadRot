...
public sealed partial class PumpControl : BoxContainer
{
    ...
    public PumpControl(GasVentPumpData data, string address)
    {
        ...
        {
            _pumpDirection.AddItem(Loc.GetString("air-alarm-ui-vent-pump-direction", ("dir", (int) value)), (int) value); // Ru-Localization
        }
        ...
        {
            _pressureCheck.AddItem(Loc.GetString("air-alarm-ui-vent-pressure-bound", ("bound", (int) value)), (int) value); // Ru-Localization
        }
