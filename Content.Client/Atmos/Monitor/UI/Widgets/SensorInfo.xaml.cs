...
public sealed partial class SensorInfo : BoxContainer
{
    ...
    public SensorInfo(AtmosSensorData data, string address)
    {
        ...
        SensorAddress.Title = $"{address} : {Loc.GetString("air-alarm-ui-window-alarm-type", ("type", $"{data.AlarmState}"))}"; // Ru-Localization
        ...
        AlarmStateLabel.SetMarkup(Loc.GetString("air-alarm-ui-window-alarm-state-indicator",
                    ...
                    ("state", Loc.GetString("air-alarm-ui-window-alarm-type", ("type", $"{data.AlarmState}"))))); // Ru-Localization
        ...
        foreach (var (gas, amount) in data.Gases)
        {
            ...
            label.SetMarkup(Loc.GetString("air-alarm-ui-gases-indicator", ("gas", Loc.GetString($"atmos-gas-{gas}")), // Ru-Localization
            ...
            var gasThresholdControl = new ThresholdControl(Loc.GetString($"air-alarm-ui-thresholds-gas-title", ("gas", Loc.GetString($"atmos-gas-{gas}"))), threshold, AtmosMonitorThresholdType.Gas, gas, 100); // Ru-Localization
    ...
    {
        SensorAddress.Title = $"{_address} : {Loc.GetString("air-alarm-ui-window-alarm-type", ("type", $"{data.AlarmState}"))}"; // Ru-Localization
