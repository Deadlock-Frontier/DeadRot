...
bounty-item-scrap = Космический лом
...
bounty-item-microwave-machine-board = Печатная плата микроволновки
...
bounty-item-remains = Ядро повелителя роя
...
bounty-description-ring = В этот ОСОБЕННЫЙ день у мистера Гельта должна состоятся свадьба, но УЖАС, он умудрился потерять кольца накануне, потому, он просит вас срочно прислать ему новую пару колец!
