...
uplink-emp-grenade-desc = Граната, предназначенная для выведения из строя электроники. Пригодится для нарушения коммуникаций, отключения энергетического оружия службы безопасности и ЛКП, если вы оказались в стеснённых обстоятельствах.
...
uplink-observation-kit-desc = В комплект входят консольная плата монитора камер наблюдения, и визор службы безопасности, замаскированный под солнцезащитные очки.
...
uplink-knives-kit-desc = Набор из 4 фирменных метательных ножей Синдиката, идеально подходящих для вонзания в тело жертвы. Игнорируют любую броню при броске
...
uplink-ammo-bundle-desc = Перезаряжаю! Содержит 4 магазина для C-20r, 4 барабана для Бульдога, 3 магазина для Estoc и 2 короба патронов для L6 SAW.
...
uplink-buldog-bundle-desc = Простой и надёжный: Содержит популярный дробовик Бульдог, барабан пуль и 4 барабана дроби.
...
uplink-syndicate-jaws-of-life-desc = Комбинация монтировки и кусачек. Используется для проникновения на станцию или в её отделы.
...
uplink-combat-medipen-name = Боевой автоинъектор
uplink-combat-medipen-desc = Одноразовый автоинъектор, содержащий химические вещества, восстанавливающие большинство видов повреждений.
...
uplink-stimpack-name = Автоинъектор гиперзина
...
uplink-stimkit-name = Набор микро-автоинъекторов гиперзина
uplink-stimkit-desc = Аптечка, содержащая 6 микро-автоинъекторов гиперзина, каждый из которых содержит дозу гиперзина на 15 секунд.
...
uplink-cat-ears-name = Кошачий набор
