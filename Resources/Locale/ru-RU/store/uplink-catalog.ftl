...
uplink-estoc-bundle-name = Марксманская винтовка Estoc
uplink-estoc-bundle-desc = Марксманская винтовка Estoc, оснащённая оптическим прицелом среднего приближения, для ведения боя на дальних дистанциях. В комплекте с двумя магазинами патронов калибра .20 винтовочные.
...
uplink-singularity-grenade-desc = Граната, имитирующая расслоение сверхматерии двигателя, притягивает всё в кучу и через некоторое время взрывается.
...
uplink-starter-kit-desc = Содержит 40 телекристаллов основного снаряжения оперов. Для тех оперативников, которые просто не знают, что им купить.
# Tools
