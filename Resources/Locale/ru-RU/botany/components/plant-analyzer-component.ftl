...
plant-analyzer-output = { $yield ->
    ...
    *[other]
        У него есть [color=lightgreen]{ $yield } { $potency }[/color]{ $seedless ->
...
plant-analyzer-printout = [color=#9FED58][head=2]Отчёт Анализатора Растений[/head][/color]{ $nl }──────────────────────────────{ $nl }[bullet/] Вид: { $seedName }{ $nl }{ $indent }[bullet/] Жизнееспособный: { $viable ->
