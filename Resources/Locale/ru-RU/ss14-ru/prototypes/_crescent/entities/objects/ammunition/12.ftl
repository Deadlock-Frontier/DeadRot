...
ent-MagazineHeavyRifleEmpty = 16-round heavy magazine (12.7×99mm USM)
    .desc = { ent-MagazineHeavyRifle.desc }
ent-MagazineHeavyRifleBoxmag = 50-round box magazine (12.7x99mm USM)
    .desc = { ent-BaseItem.desc }
ent-MagazineHeavyRifleBoxmagEmpty = 50-round box magazine (12.7x99mm USM)
    .desc = { ent-MagazineHeavyRifleBoxmag.desc }
