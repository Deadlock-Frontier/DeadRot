...
ent-ClothingOuterHardsuitCMMEnsing = ensign patrol suit
    .desc = A gliessian attempt to modernize the design of the reinforced-patrol hardsuit and cut down its weigh. Due to lack of needed technology and resources some armor had to be sacrficed in order to achive that goal.
