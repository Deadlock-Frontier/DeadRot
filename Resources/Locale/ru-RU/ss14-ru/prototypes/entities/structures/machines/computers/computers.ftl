...
ent-ComputerStationRecords = консоль учёта экипажа
    .desc = По нему можно проверять записи экипажа.
...
ent-CentcommComputerComms = консоль связи Центрального Командования
    .desc = Компьютер, используемый для создания объявлений по всему миру с помощью клавиатуры. Старший двоюродный брат обычного компьютера связи.
...
ent-ComputerCargoOrdersSecurity = консоль заказа грузов службы безопасности
...
ent-ComputerSalvageJobBoard = консоль утилизаторских запросов
    .desc = Консоль для доступа к утилизаторским запросам, если вы достаточно смелы (или тупы).
