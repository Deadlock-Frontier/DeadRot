...
ent-FoodSnackNutribrickOpen = питательный батончик
    .desc = A synthetic protein (SCOP) nutrient block, able to sustain a human body for hours on end. Purely designed for survival, not taste.
...
ent-FoodSnackAncientPizza = space pizza
    .desc = At some point in time this probably looked delicious.
    .suffix = { ent-FoodSnackAncientBurger.suffix }
