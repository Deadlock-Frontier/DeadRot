...
ent-FoodDoughCottonSlice = ломтик хлопкового теста
    .desc = Ломтик теста из хлопка.
ent-FoodDoughCottonRope = веревка из теста
    .desc = Тонкая нитка из хлопкового теста. Может быть приготовлена в хлопковый бублик.
ent-FoodDoughCottonFlat = плоское хлопковое тесто
    .desc = Расплющенный кусок хлопкового теста.
ent-FoodCroissantRawCotton = сырой хлопковое круассан
    .desc = Маслянистый, слоистый, волокнистый деликатес, который вот-вот превратится в нечто вкусное.
