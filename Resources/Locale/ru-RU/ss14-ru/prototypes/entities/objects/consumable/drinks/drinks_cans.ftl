...
ent-DrinkSolDryCan = банка солнечной газировки
...
ent-DrinkChangelingStingCan = банка Жала Метаморфа
...
ent-DrinkLemonLimeCranberryCan = банка лимон-лайм-клюквы
    .desc = Хотите лимонно-клюквенный напиток? Любим администраторами. Употребляйте в меру. Ограниченный выпуск на праздники!
