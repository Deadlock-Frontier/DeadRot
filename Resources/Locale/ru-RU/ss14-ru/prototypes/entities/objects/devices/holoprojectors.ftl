...
ent-HolofanProjectorBorg = встроенный голопроектор
    .desc = Останавливает суицидально настроенных пассажиров от убийства остальных во время разгерметизации. Встроен прямо в корпус борга, перезаряжается со временем.
