...
ent-ClothingOuterArmorCentcommCarapace = панцирь Центкома
    .desc = Бронированный нагрудник, обеспечивающий защиту и при этом максимальную подвижность и гибкость. Выдается только должностным лицам и агентам Центкома.
...
ent-ClothingOuterArmorChangeling = хитиновый панцирь
    .desc = Раздувает тело метаморфа во всепоглощающий массив хитиновый брони. Обеспечивает высокую защиту от физических повреждений, более низкую от других типов. Его вес замедляет движение метаморфа, а его поддержание замедляет выработку химических веществ.
