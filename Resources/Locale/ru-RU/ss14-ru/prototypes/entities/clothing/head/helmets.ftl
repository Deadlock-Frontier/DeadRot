...
ent-ClothingHeadHelmetLing = хитиновый шлем
    .desc = Раздувает тело метаморфа во всепоглощающий массив хитиновой брони. Обеспечивает высокую защиту от физических повреждений, более низкую от других типов. Его вес замедляет движение метаморфа, а его поддержание замедляет выработку химических веществ.
