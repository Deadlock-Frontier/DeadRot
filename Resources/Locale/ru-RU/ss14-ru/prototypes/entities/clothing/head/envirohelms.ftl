...
ent-ClothingHeadEnvirohelmResearchDirector = mystagogue's envirosuit helmet
...
ent-ClothingHeadEnvirohelmNanotrasenRepresentative = corporate liaison envirosuit helmet
    .desc = A black envirosuit helmet worn by the Corporate Liaison, with black and gold accents.
