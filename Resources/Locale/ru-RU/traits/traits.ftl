...
trait-description-Tradeband =Это промежуточный язык, доступный для всех фракций. Космонавты, независимые, TAP и роли, ориентированные на торговлю, знают этот язык автоматически.
...
trait-description-AnimalFriend =
    Вы находите общий язык с животными. Животные никогда не будут атаковать вас, если вы не атакуете их первым.
...
trait-description-PowerOverwhelming =
    УЗРИТЕ МОЮ НЕНАВИСТЬ, СМЕРТНЫЕ, ТРЕПЕЩИТЕ ПРЕД МОЕЙ ПСИОНИЧЕСКОЙ МОЩЬЮ! РЕАЛЬНОСТЬ ТАКОВА, КАКОВОЙ Я ЕЁ ВОСПРИНИМАЮ.

trait-name-LowDampening = Дефект kδ
trait-description-LowDampening =
    Ваше мастерство в манипулировании ноосферой слабее, чем у других. Вы можете испытывать непреднамеренные эффекты от использования своих способностей.

trait-name-HighDampening = Искусность kδ
trait-description-HighDampening =
    Вы искусны в тонком манипулировании ноосферой. Ваши силы с меньшей вероятностью проявляют непреднамеренные эффекты.
...
trait-description-CyberEyesMedical =
    Ваши Кибер-глаза были улучшены и теперь включают встроенный MedHud и Chemical Analysis Hud, позволяя вам отслеживать относительное состояние здоровья биологических организмов и определять химические вещества в любом растворе.

trait-name-CyberEyesDiagnostic = Кибер-глаза: Модуль диагностики
trait-description-CyberEyesDiagnostic =
    Ваши Кибер-глаза были улучшены и теперь включают встроенный Diagnostic Hud и защиту от вспышек, позволяя вам отслеживать состояние синтетических существ и обеспечивая защиту глаз от сварочных дуг.
...
trait-description-LightAmplification =
    Ваши Кибер-глаза были улучшены модулем усилителя света, позволяя пользователю переключаться между стандартным зрением и режимом «Ночного видения».
...
trait-description-VoidbornBlackeye =
    Вы теряете свои особые способности Войдборна и уважение среди сверстников в обмен на несколько очков. По сути, вы Войдборн только по названию, а не на практике.
...
trait-description-SecurityEyesModule =
    Модуль, устанавливаемый в ИПС, которые работают в отделе безопасности и подобных, этот модуль считается контрабандой и может быть удалён, если юнит не работает в отделе безопасности.

trait-name-MedicalEyesModule = Модуль глаз ИПС: Медицинский
trait-description-MedicalEyesModule =
    Ваши глаза были улучшены и теперь включают встроенный Medical Hud и химический анализатор, позволяя вам отслеживать относительное состояние здоровья биологических организмов и определять химические вещества в любом растворе.

trait-name-DiagnosticEyesModule = Модуль глаз ИПС: Диагностика
trait-description-DiagnosticEyesModule =
    Ваши глаза были улучшены и теперь включают встроенный Diagnostic Hud и защиту от вспышек, позволяя вам отслеживать состояние синтетических существ и обеспечивая защиту глаз от сварочных дуг.
...
trait-description-LightAmplificationModule =
    Ваше зрение было улучшено модулем усилителя света, позволяя пользователю переключаться между стандартным зрением и режимом «Ночного видения».
