...
shell-can-only-run-from-pre-round-lobby = Вы можете выполнить эту команду только перед стартом раунда, в лобби.
shell-can-only-run-while-round-is-active = Вы можете выполнить эту команду только при идущем раунде.
